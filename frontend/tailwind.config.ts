    ...
    extend: {
      ...
      colors: {
        ...
        tricolor: {
          ...
          white: "hsl(var(--tricolor-white))",
          green: "hsl(var(--tricolor-green))",
          navy: "hsl(var(--tricolor-navy))",
        },
        eligible: "hsl(var(--eligible))",
        "possibly-eligible": "hsl(var(--possibly-eligible))",
        "not-eligible": "hsl(var(--not-eligible))",
        chat: {
          bg: "hsl(var(--chat-bg))",
